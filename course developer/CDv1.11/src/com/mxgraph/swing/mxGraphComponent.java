/**
 * $Id: mxGraphComponent.java,v 1.1 2011/06/23 06:41:29 administrator Exp $
...
public class mxGraphComponent extends JScrollPane implements Printable
{
	 ...
	 * 
	 */
	public static ImageIcon DEFAULT_LOCKED_ICON = null;
...
//				.getResource("/com/mxgraph/swing/images/warning.gif"));
		DEFAULT_WARNING_ICON = new ImageIcon(mxGraphComponent.class
				.getResource("/com/mxgraph/swing/images/lock.png"));
		DEFAULT_LOCKED_ICON=new ImageIcon(mxGraphComponent.class
				.getResource("/com/mxgraph/swing/images/lock.png"));
	}
	...
	//protected Color pageBackgroundColor = new Color(0, 0, 0);
	...
	public mxICellOverlay[] getCellOverlays(Object cell)
	{
		...
		mxICellOverlay[] mxoverlay=overlays.get(cell);
		if(mxoverlay!=null&&mxoverlay.length>0){
			return mxoverlay;
		}
		else return null;
		}
	...
	{
		return setCellWarning(cell, null, null, false);
	}
	/**
	 * Creates an overlay for the given cell using the warning and image or
	 * warningImage and returns the new overlay. If the warning is null or a
	...
	public void removeCellWarning(final Object cell)
	{
		removeCellOverlays(cell);
	}
//	public mxICellOverlay setCellWarning(final Object cell, String warning,
...
//	}
	 ...
	 * should select the corresponding cell. Default is false.
	 */
	public mxICellOverlay setCellLocked(final Object cell, String warning,
			ImageIcon icon, boolean select)
	{
		if (warning != null && warning.length() > 0)
		{
	...
	public class mxGraphControl extends JComponent
	{
		 ...
		 * 
		 * 在给定的canvas中绘制出所给的cell，只有当相应的label没有被编辑的时候显示之
