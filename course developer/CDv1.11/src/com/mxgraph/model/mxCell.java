/**
 * $Id: mxCell.java,v 1.1 2011/06/23 06:41:35 administrator Exp $
...
public class mxCell implements mxICell, Cloneable, Serializable
{
	...
	protected String id;
	/**
	 * Holds the prunednum. Default is null.
	 */
	public int prunedtime=0;
	public int getPrunedtime() {
		return prunedtime;
	}

	public void setPrunedtime(int prunedtime) {
		this.prunedtime = prunedtime;
	}
	public int prunednum=0;
	public int getPrunednum() {
		return prunednum;
	}

	public void setPrunednum(int prunednum) {
		this.prunednum = prunednum;
	}
	public int layer=0;
	...
	/**
	 * set the mark to see if the cell have been visited
	 * */
		public int visited=0;
	/**
	 * set the mark to see if the cell have been visited
	 * */
	public int prunable=1;
	/**
	...
	{
//		style+=";mxConstants.STYLE_FONTFAMILY=\"ËÎÌו,Arial\"";//define the fontStyle
//		style+=";fontFamily=ËÎÌו";
		return style;
	}
