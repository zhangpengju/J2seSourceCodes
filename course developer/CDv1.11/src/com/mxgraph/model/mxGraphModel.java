/**
 * $Id: mxGraphModel.java,v 1.1 2011/06/23 06:41:35 administrator Exp $
...
public class mxGraphModel extends mxEventSource implements mxIGraphModel
{
	...
	/**
	 * returns the edge between the two cells
	 * 
	 * */
	//public static Objcet[] 
	/**
