	...
	public UserObject()
	{
		...
		try
		{
			...
			Object v2 = graph.insertVertex(parent, null, person2, 240, 150, 80,
					30);
			Object v3=graph.insertVertex(parent, null, person2, 80, 20, 80,30);
			Object eObject=graph.insertEdge(parent, null, relation, v1, v2);
//			try {
//				Object eObject2=((mxCell)eObject).clone();
//				((mxCell)eObject2).setTarget((mxICell)v3);
//				((mxCell)eObject2).setSource((mxICell)v2);
//			} catch (CloneNotSupportedException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
			
			graph.insertEdge(parent, null, ((mxCell)eObject).getValue(), v2, v3,((mxCell)eObject).getStyle());
//			try {
////				Object v3=((mxCell)v2).clone();
////				graph.addCell(v3);
//				graph.insertEdge(parent, null, relation, v2, v3);
//			} catch (CloneNotSupportedException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
