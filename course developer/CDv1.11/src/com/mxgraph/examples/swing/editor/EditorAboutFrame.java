...
public class EditorAboutFrame extends JDialog
{
	...
	public EditorAboutFrame(Frame owner)
	{
		...
		JLabel titleLabel = new JLabel("课程开发建模工具");
...
//				"For more information visit http://www.mxgraph.com/");
		...
		content.add(new JLabel("软件功能：本软件用于课程开发中对知识的分析"));
		

		content.add(new JLabel("主要操作：我们主要用它来进行知识建模" ));
		content.add(new JLabel("如何进行知识建模：请参考杨开城老师有关论文."));
		content.add(new JLabel(""));
		content.add(new JLabel(" "));
