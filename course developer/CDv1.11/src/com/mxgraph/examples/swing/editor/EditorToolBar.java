...
public class EditorToolBar extends JToolBar
{
	 ...
	 * 
	 */
	public EditorToolBar(final CDSoftWare editor, int orientation)
	{
		super(orientation);
...
//				"/com/mxgraph/examples/swing/images/new.gif"));
		add(editor.bind("New",  new AbstractAction() {
		...
		fonts.addAll(Arrays.asList(new String[] { "宋体", "Verdana",
		...
		fontCombo.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					mxGraph graph = editor.getBasicGraphEditor().getGraphComponent().getGraph();
					graph.setCellStyles(mxConstants.STYLE_FONTFAMILY, font);
				}
			}
		});

		final JComboBox sizeCombo = new JComboBox(new Object[] { "24pt", "6pt","8pt",
